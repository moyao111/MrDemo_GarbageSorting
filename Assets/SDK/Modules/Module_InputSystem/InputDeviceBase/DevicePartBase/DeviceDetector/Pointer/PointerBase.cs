...
namespace SC.XR.Unity.Module_InputSystem {
    ...
    public abstract class PointerBase : SCModuleMono ,IPointer{
        ...
        public override void OnSCStart() {
            ...
            EnsureEventSystem();
            if (Module_Device.Module_Device.getInstance.CurrentAndroid != null && Module_Device.Module_Device.getInstance.CurrentAndroid.type == Module_Device.AndroidDeviceType.Other) {
