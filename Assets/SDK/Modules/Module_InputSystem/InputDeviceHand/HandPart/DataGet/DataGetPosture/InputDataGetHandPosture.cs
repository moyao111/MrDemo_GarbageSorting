    ...
    public class InputDataGetHandPosture : InputDataGetOneBase {
        ...
        protected virtual void OnUpdateHandTransform() {
            ...
            if(API_GSXR_Slam.SlamManager != null && API_GSXR_Slam.SlamManager.gameObject.activeSelf) {
                inputDataGetHand.inputDeviceHandPart.inputDataHand.position = API_GSXR_Slam.SlamManager.head.transform.TransformPoint(inputDataGetHand.inputDeviceHandPart.inputDataHand.handInfo.localPosition + inputDataGetHand.inputDeviceHandPart.inputDataHand.handInfo.positionOffest);
                inputDataGetHand.inputDeviceHandPart.inputDataHand.rotation =Quaternion.Euler( API_GSXR_Slam.SlamManager.head.transform.eulerAngles + inputDataGetHand.inputDeviceHandPart.inputDataHand.handInfo.eulerAnglesOffset);
