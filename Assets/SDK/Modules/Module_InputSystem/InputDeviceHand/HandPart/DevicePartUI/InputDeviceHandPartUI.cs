...
namespace SC.XR.Unity.Module_InputSystem.InputDeviceHand {
    public class InputDeviceHandPartUI : InputDevicePartUIBase {
        ...
        public override void OnSCLateUpdate() {
            base.OnSCLateUpdate();
            if(inputDeviceHandPart && API_GSXR_Slam.SlamManager) {
                handHead = API_GSXR_Slam.SlamManager.head.position - inputDeviceHandPart.inputDataHand.handInfo.centerPosition;
