...
class GSXRPluginAndroid : GSXRPlugin
{
    ...
    [DllImport(DLLName)]
    private static extern int GSXRGetLatestCameraBinocularData(ref bool outBUdate, ref uint outCurrFrameIndex, ref ulong outFrameExposureNano, byte[] outLeftFrameData, byte[] outRightFrameData);
    ...
    [DllImport(DLLName)]
    private static extern void GSXRGetDeviceName(ref string deviceName);
    public override XRType GSXR_Get_XRType() { return (XRType)GSXRGetXRType(); }

    public override void GSXR_Get_DeviceName(ref string deviceName) { GSXRGetDeviceName(ref deviceName); }
    #endregion
}
