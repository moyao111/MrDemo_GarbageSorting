...
{
    private GSXRManager svrManager = null;
    ...
    {
        svrManager.SetOverlayFade(GSXRManager.eFadeState.FadeOut);
    ...
    void Update()
    {
        ...
        if (!Input.backButtonLeavesApp &&
            CheckButton(Input.GetKey(KeyCode.Escape) || (PrimaryController && PrimaryController.GetButton(GSXRController.svrControllerButton.Back)), 
        ...
        if (CheckButton(Input.GetMouseButton(0) || Input.GetKey((KeyCode)10) || (PrimaryController && PrimaryController.GetButton(GSXRController.svrControllerButton.PrimaryThumbstick)), 
